...
const sergio = new Wallet();
const dan = new Wallet();
const jerry = new Wallet();
sergio.sendMoney(50, dan.publicKey);
dan.sendMoney(23, jerry.publicKey);
jerry.sendMoney(5, dan.publicKey);
